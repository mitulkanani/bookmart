...
<!--http://carat-html.wearecodevision.com/-->
                ...
                <div class="col-md-7 col-sm-7">
                    <div id="slider">
                        <div class="slide active">
                            <a href="detail.html"><img src="assets/img/slides/toyota.png" alt="#"></a>
                ...
                <div class="row">
                    <div class="category-box col-lg-3 col-md-3 col-sm-6">
                        <div class="wrapper">
                            <div class="picture">
                                <a href="detail.html">
                                    <img src="assets/img/filter/sedan.png" class="cover-me" alt="#">
                                </a>
                            </div><!-- /.picture -->
                    ...
                    <div class="category-box col-lg-3 col-md-3 col-sm-6">
                        <div class="wrapper">
                            <div class="picture">
                                <a href="detail.html">
                                    <img src="assets/img/filter/bike.png" class="cover-me" alt="#">
                                </a>
                            </div><!-- /.picture -->
                    ...
                    <div class="category-box col-lg-3 col-md-3 col-sm-6">
                        <div class="wrapper">
                            <div class="picture">
                                <a href="filter.html"><img src="assets/img/filter/suv.png" alt="#" class="cover-me"></a>
                            </div><!-- /.picture -->
                    ...
                    <div class="category-box col-lg-3 col-md-3 col-sm-6">
                        <div class="wrapper">
                            <div class="picture">
                                <a href="detail.html">
                                    <img src="assets/img/filter/sportcar.png" alt="#" class="cover-me">
                                </a>
                            </div>
                            <div class="meta">
                                <div class="title">
