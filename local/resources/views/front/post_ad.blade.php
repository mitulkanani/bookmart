    ...
    <div id="page-wrapper">
        <form method="post" style="background-color:#FFFFFF;font-size:14px;font-family:'Roboto',Arial,Helvetica,sans-serif;color:#34495E;margin-top: -8px;"
            ...
            <div class="element-input field-book desc" style="display: none;">
                ...
                <div class="item-cont">
                    <input  type="text" placeholder="Author-name" name="author_name" class="large"/>
                    <span class="icon-place"></span>
                </div>
            </div>
            <div class="element-input field-book desc" style="display: none;">
            ...
            <div class="element-input">
                <label class="title"></label>
                <div class="item-cont">
                    <textarea  type="text" placeholder="Description" name="description" class="large" style="height: 63px;"></textarea>
                    <span class="icon-place"></span>
                </div>
            </div>
            ...
            <div class="element-input">
                <label class="title"></label>
                <div class="item-cont">
                    <input required="true" type="password" placeholder="Password" maxlength="10" name="password" class="large"/>
                    <span class="icon-place"></span>
                </div>
            </div>
            <div class="element-phone">
                <label class="title"></label>
                <div class="item-cont">
                    <input required="true" type="tel" value="" placeholder="Mobile no." name="mobileno" maxlength="24" pattern="[+]?[\.\s\-\(\)\*\#0-9]{3,}" class="large">
                    <span class="icon-place"></span>
                </div>
            </div>
            <div class="element-input">
