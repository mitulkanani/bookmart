...
<section id="content">
    <div class="search-box-wrapper" style="margin-top: 69px;">
        <div class="search-box container">
            <ul class="search-tabs clearfix" style="margin-top: -39px;">
                ...
                <li><a href="open_store" id="open_store" >STORE</a></li>
            </ul>
                    ...
                    <form action="hotel-list-view.html" method="post">
                        <div class="row">
                            <div class="form-group col-sm-6">
                                <input id="adtitle-search"  type="text" class="input-text full-width" placeholder="Search by book name or Ad title...." />
                            </div>
                            <div class="form-group col-sm-6">
                                <input id="author-search"  type="text" class="input-text full-width" placeholder="Search by Author name...." />
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="form-group col-sm-2">
                                <button type="submit" class="full-width  animated" data-animation-type="bounce" data-animation-duration="1"><span class="glyphicon glyphicon-refresh" style="left: -24px;"></span>Refresh</button>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <main class="cd-main-content">
        ...
        <section class="cd-gallery" style="padding-bottom: 0;" >
            <div class="items-container row image-box style8" id="ullist">
                <ul class="search-result-replace">
    ...
    <div class="container">
        <div class="section">
            ...
            <div class="flexslider image-carousel style2 row-2" data-animation="slide" data-item-width="370" data-item-margin="30">
                ...
                <div class="flex-viewport" style="overflow: hidden; position: relative;"><ul class="slides image-box style11" style="width: 800%; transition-duration: 0.6s; transform: translate3d(0px, 0px, 0px);">
                        <li style="width: 370px; float: left; display: block;">
                            <article class="">
                                <figure>
                                    <a title="" href="#"><img width="370" height="161" alt="" src="ads_picture/original/1458543573.jpg" ></a>
                                    <figcaption>
                                        <h3 class="caption-title">Orlando</h3>
                                        <span>orlando hotels</span>
                                    </figcaption>
                                </figure>
                                <h4 style="margin: 0px;font-size: 17px;">Computer science</h4>
                            </article>
                            <article class="">
                                <figure>
                                    <a title="" href="#"><img width="370" height="161" alt="" src="ads_picture/original/1458543573.jpg"></a>
                        ...
                        <li style="width: 370px; float: left; display: block;">
                            <article class="">
                                <figure>
                                    <a title="" href="#">
                                        <img width="370" height="161" alt="" src="ads_picture/original/1458543573.jpg">
                                    </a>
                                    <figcaption>
                                        <h3 class="caption-title">Orlando</h3>
                                        <span>orlando hotels</span>
                ...
                <ol class="flex-control-nav flex-control-paging"><li>
                        <a class="flex-active">1</a></li><li><a class="">4</a></li></ol><ul class="flex-direction-nav"><li><a class="flex-prev" href="#">Previous</a></li><li><a class="flex-next" href="#">Next</a></li></ul></div>

        </div>
    </div>
    <!----------- How it works box--------------->
    <div class="global-map-area section parallax" data-stellar-background-ratio="0.5" style="background-position: 50% 53px;">
        <div class="container description text-center" style="height: 500px;">
            <h1>How It Works?</h1>
            <br>
            <div class="bookmart-process">
                <img src="images/front/bookmart_process.png" alt="">
                <div class="process first icon-box style12">
                    <div class="details animated fadeInUp" data-animation-type="fadeInUp" data-animation-delay="2" style="animation-duration: 1s; animation-delay: 1s; visibility: visible;">
                        <h4>Post Free ad</h4>
                        <p class="hidden-xs">If you want to sale or rent your book u can post free ad by clicking on "Post Ad" & get right customer</p>
                    </div>
                ...
                <div class="process second icon-box style12">
                    <div class="icon-wrapper animated slideInRight" data-animation-type="slideInRight" data-animation-delay="1.5" style="animation-duration: 1s; animation-delay: 1.5s; visibility: visible;">
                        <i class="soap-icon-search circle"></i>
                    </div>
                    <div class="details animated fadeInUp" data-animation-type="fadeInUp" data-animation-delay="2.5" style="animation-duration: 1s; animation-delay: 2.5s; visibility: visible;">
                        <h4>Search book</h4>
                        <p class="hidden-xs">Search book whatever u want to buy and read details and see images</p>
                    </div>
                </div>
                <div class="process third icon-box style12">
                    ...
                    <div class="details animated fadeInUp" data-animation-type="fadeInUp" data-animation-delay="3" style="animation-duration: 1s; animation-delay: 3s; visibility: visible;">
                        <h4>Call owner</h4>
                        <p class="hidden-xs">Call owner to fix rate and fix the venue & fix meeting.such as meet at your clg and get the book</p>
                    </div>
                </div>
                <div class="process forth icon-box style12">
                    <div class="details animated fadeInUp" data-animation-type="fadeInUp" data-animation-delay="4.5" style="animation-duration: 1s; animation-delay: 4.5s; visibility: visible;">
                        <h4>Make deal</h4>
                        <p class="hidden-xs">Make better deal and get money without any shopper between you.</p>
                    </div>
...
<script>
            function testAjax2(handleData) {
            $.ajax({
            'async': false,
                    'global': false,
                    'url': "search_json/books.json",
                    'dataType': "json",
                    'success': function(data) {
                    var jsonOutput = [];
                            for (var i = 0, l = data.length; i < l; i++) {
                    var json = data[i].ad_title;
                            jsonOutput.push(json);
                    }
                    handleData(jsonOutput);
                    },
            });
            }

    testAjax2(function(output) {
    var widget = $("#adtitle-search").kendoAutoComplete({
    dataSource: output,
            filter: "startswith",
            change: onChange,
            ...
            var searchvalue = this.value();
                    ...
                    type: "POST",
                            ...
                            success: function(data) {
                            $(".waiting").hide()
                                    $('.search-result-replace').html(data);
    ...
    'async': false,
            ...
            var jsonOutput = [];
                    for (var i = 0, l = data.length; i < l; i++) {
            var json = data[i].clg_name + ',' + data[i].city;
                    jsonOutput.push(json);
            }
            handleData(jsonOutput);
            },
    ...
    var widget = $("#college-search").kendoAutoComplete({
    dataSource: output,
            filter: "startswith",
            change: onClgChange,
            headerTemplate: '<div class="noDataMessage">No results found</div>',
